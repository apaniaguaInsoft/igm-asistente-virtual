  ...
  children:[
    { id:"1.1", label:"Pasaportes", type:"menu", cat:"pasaportes",
      ...
      children:[
        ...
        { id:"1.1.5", label:"Ver más opciones →", type:"menu", cat:"pasaportes",
          intents:[],
          detail:`📘 <strong>Pasaportes › Más opciones</strong>\n\n¿Qué información necesita?`,
          children:[
            { id:"1.1.5.1", label:"Extensión de pasaporte", type:"final", cat:"pasaportes",
            ...
            { id:"1.1.5.2", label:"Pérdida, robo o pasaporte deteriorado", type:"final", cat:"pasaportes",
            ...
            { id:"1.1.5.3", label:"Pasaporte en el extranjero", type:"final", cat:"pasaportes",
            ...
            { id:"1.1.5.4", label:"Devolución de pago", type:"final", cat:"pasaportes",
            ...
            agentSubflow("Pasaportes","pasaportes","1.1.5.5"),
          ]},
        agentSubflow("Pasaportes","pasaportes","1.1.6"),
      ]},
    ...
    { id:"1.6", label:"🏡 Plan Retorno al Hogar", type:"menu", cat:"prh",
      ...
      children:[
        ...
        { id:"1.6.5", label:"Ver más preguntas →", type:"menu", cat:"prh",
          intents:[],
          detail:`🏡 <strong>Plan Retorno al Hogar › Más preguntas frecuentes</strong>\n\n¿Qué información necesita?`,
          children:[
            { id:"1.6.5.1", label:"¿Dónde puedo tomar el bus a mi destino?", type:"final", cat:"prh",
            ...
            { id:"1.6.5.2", label:"¿Cómo registro a mis hijos nacidos en EE.UU.?", type:"final", cat:"prh",
            ...
            { id:"1.6.5.3", label:"¿Dónde buscar trabajo en Guatemala?", type:"final", cat:"prh",
            ...
            { id:"1.6.5.4", label:"¿Cómo emprender un negocio?", type:"final", cat:"prh",
            ...
            { id:"1.6.5.5", label:"Ver más preguntas →", type:"menu", cat:"prh",
              intents:[],
              detail:`🏡 <strong>Plan Retorno al Hogar › Más preguntas frecuentes</strong>\n\n¿Qué información necesita?`,
              children:[
                { id:"1.6.5.5.1", label:"¿Puedo solicitar visa si mi salida fue voluntaria?", type:"final", cat:"prh",
                ...
                { id:"1.6.5.5.2", label:"¿Hay empresas que contraten personas retornadas?", type:"final", cat:"prh",
                ...
                { id:"1.6.5.5.3", label:"¿Cómo inscribo a mis hijos en la escuela?", type:"final", cat:"prh",
                ...
                { id:"1.6.5.5.4", label:"¿Tiene una necesidad especial o urgente?", type:"final", cat:"prh",
                ...
                { id:"1.6.5.5.5", label:"Ver más preguntas →", type:"menu", cat:"prh",
                  intents:[],
                  detail:`🏡 <strong>Plan Retorno al Hogar › Más preguntas frecuentes</strong>\n\n¿Qué información necesita?`,
                  children:[
                    { id:"1.6.5.5.5.1", label:"¿Dónde conseguir apoyo alimentario?", type:"final", cat:"prh",
                    ...
                    { id:"1.6.5.5.5.2", label:"¿Perdió su Constancia de Retorno?", type:"final", cat:"prh",
                    ...
                    { id:"1.6.5.5.5.3", label:"¿Busca información sobre un familiar que retorna?", type:"final", cat:"prh",
                    ...
                    agentSubflow("Plan Retorno al Hogar","prh","1.6.5.5.5.4"),
                  ]},
                agentSubflow("Plan Retorno al Hogar","prh","1.6.5.5.6"),
              ]},
            agentSubflow("Plan Retorno al Hogar","prh","1.6.5.6"),
          ]},
        agentSubflow("Plan Retorno al Hogar","prh","1.6.6"),
      ]},
  ]
};